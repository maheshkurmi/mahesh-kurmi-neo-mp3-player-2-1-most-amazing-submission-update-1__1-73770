...
Private Declare Function FrameRect Lib "user32" (ByVal hDC As Long, lprc As RECT, ByVal hBR As Long) As Long
...
Public WithEvents m_clsSB As Scrollbars
...
'Public Enum OLEDropModeConstants 'already declared in modDeclaration for vkcontrols
'OLEDropNone
'OLEDropManual
'End Enum
                ...
                If m_colColumns.Item(j).Visible Then
                    ...
                    If m_clsCustDrawCB.CustomDraw(i, j, lngCustBGColor, lngCustFGColor) Then
                        ...
                        Else
                            ...
                            m_clsCustBGColor.SetColor RGB(215, 215, 215), True
                            Dim nn
                            nn = udtItem.X1
                            udtItem.X1 = udtItem.X2 - 1
...
Private Sub DrawColumns()
    ...
    If m_blnColumnsVisible Then
        ...
        SetTextColor m_hDCBack, TranslateColor(&H555555)    'RGB(215, 215, 215) ' TranslateColor(vbButtonText)
...
Private Sub UserControl_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If m_clsItems.ItemCount = 0 Then Exit Sub
    ...
    Case vbKeyUp, vbKeyDown, vbKeyPageDown, vbKeyPageUp, vbKeyHome, vbKeyEnd
        ...
        Case vbKeyEnd
            m_lngSelItemIndex = m_clsItems.ItemCount - 1
            m_clsSB.Value(efsVertical) = m_lngSelItemIndex
            RaiseEvent Click(m_lngSelItemIndex)
        End Select
    ...
    If X <= m_lngColumnsWidth Then
        ...
        ElseIf Y >= m_udtITRect.Y1 And Y <= m_udtITRect.Y2 Then
            ...
            If lngClickedItem <= m_clsItems.ItemCount - 1 And lngClickedItem >= 0 Then
                ...
                If m_clsItems.Item(lngClickedItem).Selected Or (m_blnReorder And Not m_blnMultiSelect) Then
...
Private Sub UserControl_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Case MouseOverResizeColumn
        ...
        If Not m_blnColumnsAutoSize Then
            ...
            'setautosizewidth equal to width
            m_colColumns.Item(i).WidthAutoSized = lngColWidthNew
    ...
    Case MouseOverReorder
        If (Not m_blnReorder) And (m_lngSelItemIndex >= 0) And Button = vbLeftButton Then RaiseEvent ItemDrag
        If m_blnReorder Then
            ...
            GetCursorPos udtCursorPos
            ClientToScreen UserControl.hwnd, udtLV
            'set flag false for avoiding unnecessary event raising
            m_blnItemDragged = False
            ' move items upwards
            ...
            With m_colColumns.Item(i)
                If .Visible Then
                    If .Resizable Then
                        ...
                        'store infin width so thtanew autoresize may take ratio from the current values
                        .Width = .WidthAutoSized - 0.5
                    End If
