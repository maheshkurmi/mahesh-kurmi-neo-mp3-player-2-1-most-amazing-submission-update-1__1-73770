...
k = iValue
 ...
 If ePosition = Vertical Then
    ...
    If y >= iY And y <= iY + picBar.ScaleHeight Then
        iY = iY + y - iY - picBar.ScaleHeight / 2
       If iY <= 0 Then iY = 0
       If iY >= picBack.ScaleHeight - picBar.ScaleHeight Then iY = picBack.ScaleHeight - picBar.ScaleHeight
