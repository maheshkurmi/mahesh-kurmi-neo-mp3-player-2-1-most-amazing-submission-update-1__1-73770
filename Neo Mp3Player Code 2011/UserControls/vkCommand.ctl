...
Public Sub Refresh(Optional ByVal ShowFocusRects As Boolean = True)
    ...
    Else
        ...
        Else
            Call SetRect(R, 4, (Height / Screen.TwipsPerPixelY - GetCharHeight * X) / 2 - 1, Width / Screen.TwipsPerPixelX - 4, Height / Screen.TwipsPerPixelY)
        End If
    End If
    ...
    Else
        ...
        hRgn = CreateRoundRectRgn(0, 0, ScaleWidth / Screen.TwipsPerPixelX, _
                                  ScaleHeight / Screen.TwipsPerPixelY, 3, 3)
...
Private Sub DrawMouseEnterRect()
    ...
    'Call UserControl.Refresh 'removed to avoid flickering
